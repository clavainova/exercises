...
define('ERRORS', array(
    ...
    "501" => "You are not logged in, please log in <a href='http://localhost/progression/Dojos/4_PHP/index.php?page=settings'>here</a> or create an account to continue (error:501)",
    "502" => "No address on record, please add one <a href='http://localhost/progression/Dojos/4_PHP/index.php?page=update'>here</a> (code:502)",

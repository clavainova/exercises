...
try {
    ...
    //clavain note: also use better password encryption ffs
    $sql = $bdd->prepare("select titre, resume, id from article where titre like :nom %");
    $sql->bindParam(":nom", $txt, PDO::PARAM_STR, 26);
    $sql->execute();
    /*
